...
if TRAINING:
    autoencoder.fit(X, (X, y),
                    ...
                    callbacks=[EarlyStopping('val_loss', patience=62, restore_best_weights=True),
                               ReduceLROnPlateau(monitor='val_loss', patience=15, factor=0.5)])
    encoder.save_weights('./encoder.hdf5')
else:
    encoder.load_weights('../input/janest-weight/vae005/encoder.hdf5')
